            ...
            <div class="flex-column row">
                ...
                <div class="service-single-column col-md-6">
                    <div class="content">
                        ...
                        <h2>
                            মেশিনটির বৈশিষ্ট্যঃ <br>
                            🔰 ২ বছরের রিপ্লেসমেন্ট গ্যারান্টি।<br>
                            🔰 ১০০% অথেনটিক ও কোয়ালিটি ফুল প্রডাক্ট।<br>
                            🔰 ব্যাটারি ও চার্জার দুইভাবেই ব্যবহার করা যায়।<br>
                            🔰 ১২০ টি রেকর্ড সেভ করার মেমোরি।<br>
        ...
        <div class="container">
            <div class="main">
                ...
                <div class="flex-column why-order">
                    ...
                    <div class="left-col">
                        <h2>✅ সারাদেশে ক্যাশ অন ডেলিভারি।</span></h2>
                    </div>
                    <div class="left-col">
                        <h2>✅ বাৎসরিক কোয়ালিটি কন্ট্রোল পরীক্ষার সুযোগ*</span></h2>
                    </div>
                    <div class="left-col">
                        <h2> 🥰তাহলে আর দেরি না করে এখনই অর্ডার করুন।🥰</span></h2>
                    </div>
